...
{
    public abstract class MapContentsScriptBase(MapType mapType) : IScript
    {
        private readonly MapType mapType = mapType;
        ...
        public bool ProcessRun()
        {
            ...
            this.ws.WizardCommands.GotoMap(this.mapType);
            this.ws.WizardCommands.RevealMap();

            // Spawn and drop a MC data core so we can identify all AAs or
